...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final NhaarmanLibraryAccessors laccForNhaarmanLibraryAccessors = new NhaarmanLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at nhaarman
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public NhaarmanLibraryAccessors getNhaarman() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForNhaarmanLibraryAccessors;
    }
    ...
    public static class GoogleDaggerHiltLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final GoogleDaggerHiltNavigationLibraryAccessors laccForGoogleDaggerHiltNavigationLibraryAccessors = new GoogleDaggerHiltNavigationLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at google.dagger.hilt.navigation
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public GoogleDaggerHiltNavigationLibraryAccessors getNavigation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForGoogleDaggerHiltNavigationLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class GoogleDaggerHiltNavigationLibraryAccessors extends SubDependencyFactory {

        public GoogleDaggerHiltNavigationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        @Deprecated
            public Provider<MinimalExternalModuleDependency> getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("google.dagger.hilt.navigation.compose");
        }
     ...
     */
    @Deprecated
    public static class NhaarmanLibraryAccessors extends SubDependencyFactory {
        private final NhaarmanMockitoLibraryAccessors laccForNhaarmanMockitoLibraryAccessors = new NhaarmanMockitoLibraryAccessors(owner);

        public NhaarmanLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at nhaarman.mockito
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public NhaarmanMockitoLibraryAccessors getMockito() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForNhaarmanMockitoLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class NhaarmanMockitoLibraryAccessors extends SubDependencyFactory {

        public NhaarmanMockitoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("nhaarman.mockito.kotlin");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final NhaarmanVersionAccessors vaccForNhaarmanVersionAccessors = new NhaarmanVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.nhaarman
         */
        public NhaarmanVersionAccessors getNhaarman() {
            return vaccForNhaarmanVersionAccessors;
        }
    ...
    public static class DaggerHiltVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public DaggerHiltVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the version associated to this alias: dagger.hilt (2.47)
         * If the version is a rich version and that its not expressible as a
         * single version string, then an empty string is returned.
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("dagger.hilt"); }

            /**
             * Returns the version associated to this alias: dagger.hilt.navigation (1.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getNavigation() { return getVersion("dagger.hilt.navigation"); }
    ...
    public static class KotlinxCoroutinesVersionAccessors extends VersionFactory  {
        ...
        public KotlinxCoroutinesVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kotlinx.coroutines.test (1.7.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class MockitoVersionAccessors extends VersionFactory  {
        ...
        public MockitoVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: mockito.inline (4.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        public NavigationVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: navigation.compose (2.7.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class NhaarmanVersionAccessors extends VersionFactory  {

        public NhaarmanVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: nhaarman.mockito (2.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getMockito() { return getVersion("nhaarman.mockito"); }
